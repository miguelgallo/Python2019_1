...
################################################## UPSILON ################################################# 
    ...
    initials_upsilon =  [float(x) for x in input('Preencha com os parâmetros das duas Gaussianas e da exponencial (a1, mean1, sigma1, a2, mean2, sigma2, constante, inclinação) dando apenas um espaço entre eles: ').split()]
...
################################################### J/PSI ################################################## 
    ...
    initials_jpsi =  [float(x) for x in input('Preencha com os parâmetros da Crystal-Ball e da exponencial (a, n, mean, sigma, constante, inclinação) dando apenas um espaço entre eles: ').split()]
...
################################################### PSI' ################################################### 
    ...
    initials_psiprime =  [float(x) for x in input('Preencha com os parâmetros da Crystal-Ball e da exponencial (a, n, mean, sigma, constante, inclinação) dando apenas umespaço entre eles: ').split()]
