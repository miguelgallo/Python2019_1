...
while(choice>3 or choice<1):
    ...
    if choice == 1:
        ...
        print("a (defines how the function decreases off peak), \n n (), \n xb (mean, orders the position of the center of the peak ), \n sig (standard deviation, controls the width of the curve), \n x()")
        initials_crystal =  [float(x) for x in input('Preencha com os parâmetros da Crystal-Ball  (x, beta, m, mean, sigma): ').split()] 
        # Let's import the module that is used in the optimization, run the optimization
        # and calculate the uncertainties of the optimized parameters.
        ...
        print("The values and the uncertainties from the optimization")
        print("")
        first = "The value of x = {} +- {}".format(best_crystal[0], error_crystal[0])
        second = "The value of beta = {} +- {}".format(best_crystal[1], error_crystal[1])
        third = "The value of m = {} +- {}".format(best_crystal[2], error_crystal[2])
        fourth = "The value of mean = {} +- {}".format(best_crystal[3], error_crystal[3])
        fifth = "The value of sigma = {} +- {}".format(best_crystal[4], error_crystal[4])
